...
export default function InvoiceTable({ invoices }: InvoiceTableProps) {
  return (
    <div style={wrapperStyle}>
      {/* Desktop Table */}
      <div className="invoice-table-desktop" style={{ display: "none" }}>
      ...
      {/* Mobile Cards */}
      <div className="invoice-table-mobile" style={cardWrapperStyle}>
        {invoices.map((inv, i) => {
          const colors = STATUS_COLORS[inv.status] ?? STATUS_COLORS.draft;
            ...
            >
              ...
              <div style={cardMetaStyle}>
                <div style={cardMetaRowStyle}>
                  ...
                  <span style={{ color: theme.colors.neutral[900] }}>
      ...
      <style jsx>{`
        ...
        @media (max-width: ${parseInt(theme.breakpoints.lg) - 1}px) {
          .invoice-table-desktop {
            display: none;
          }
          .invoice-table-mobile {
